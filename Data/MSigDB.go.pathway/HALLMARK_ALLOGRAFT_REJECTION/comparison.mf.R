...
filename <- read.csv("HMK.mf.top10.txt", header=T, sep="\t", stringsAsFactors=F)
...
p.david <- c("1.5E-5", "2.1E-5", "9.0E-7", "2.1E-10", "NA", "1.9E-3", "7.9E-5","4.7E-5","2.0E-12", "NA")
note <- cbind(netbas, p.david)

png(filename= "netbas-david.mf.top10.png", width=3.5, height=6, res=1200, unit="in")

...
filename <- read.csv("HMK.kegg.cliq.txt", header=T, sep="\t", stringsAsFactors=F)
...
p.david <- c("2.3E-3", "NA", "2.6E-2", "NA", "7.0E-2", "NA", "NA", "1.6E-2", "NA", "NA")
note <- cbind(netbas, p.david)

png(filename= "netbas-david.kegg.cliq.png", width=5, height=6, res=1200, unit="in")

...
gene.file <- read.csv("kras.dn.isolated.csv", header=T, stringsAsFactors=F)
...
write.table(ensembl.id, file="isolated.geneset.txt", sep=",", row.names = F, col.names = F, quote = T)

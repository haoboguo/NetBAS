...
filename <- read.csv("HMK.kegg.perm.top10.txt", header=T, sep="\t", stringsAsFactors=F)
...
colnames(zscores) <- c("Random", "DAVID")
...
p.david <- c("4.0E-106", "4.7E-83", "8.0E-52", "4.5E-73", "7.3E-68", "6.6E-29", "NA", "1.5E-15", "NA", "1.1E-7")
note <- cbind(netbas, p.david)

png(filename= "netbas-david.kegg.perm.top10.png", width=5, height=6, res=1200, unit="in")

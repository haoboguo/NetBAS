...
filename <- read.csv("HMK.mf.new.txt", header=T, sep="\t", stringsAsFactors=F)
...
png(filename= "Net.DAV.MF10.png", width=3.5, height=6, res=1200, unit="in")
heatmap.2(zscores, col=my_palette, dendrogram='none', breaks=colors,
          ...
          ylab="Molecular Funciton Terms", xlab="",

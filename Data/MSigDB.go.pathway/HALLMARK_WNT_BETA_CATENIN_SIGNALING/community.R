...
pdf("HALLMARK_WNT_BETA_CATENIN_SIGNALING.dendro.pdf", width=10, height=4, paper='special')
plot_dendrogram(dendro, rect=0, ann=F)
dev.off()

cluster <- cluster_walktrap(sub.graph)
pdf("HALLMARK_WNT_BETA_CATENIN_SIGNALING.custer.pdf", width=5, height=5, paper='special')

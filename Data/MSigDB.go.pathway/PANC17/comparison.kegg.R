...
p.david <- c("2.6E-3", "4.3E-2", "6.2E-3", "6.7E-5", "6.1E-3", "1.4E-4", "1.4E-2", "2.4E-3", "9.4E-2", "1.9E-2")
note <- cbind(netbas, p.david)

png(filename= "netbas-david.kegg.top10.png", width=6, height=6, res=1200, unit="in")
heatmap.2(zscores, col=my_palette, dendrogram='none', breaks=colors,
          ...
          margins=c(1,15), key.title=NA, key.xlab=NA, key.ylab=NA,

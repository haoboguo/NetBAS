...
png("rri200.z.heatmap.new2.png", width=12, height=4, res=600, units="in")
...
pdf("rri200.z.network.pdf", height=8, width=8, paper='special')
plot.igraph(rri.z.net, vertex.label=c(1:50), layout=layout_in_circle,
            edge.color = coloring, edge.width=rri.weight/4, vertex.size=sqrt(200)*1.2)
dev.off()

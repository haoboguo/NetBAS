...
colors = c(seq(-10,10,length=21))
  ...
  png("rri50.z.heatmap.new2.png", width=12, height=4, res=600, units="in")
...
pdf("rri50.z.network.pdf", height=8, width=8, paper='special')
plot.igraph(rri.z.net, vertex.label=c(1:50), layout=layout_in_circle,
            edge.color = coloring, edge.width=rri.weight/4, vertex.size=sqrt(50)*1.2)
dev.off()

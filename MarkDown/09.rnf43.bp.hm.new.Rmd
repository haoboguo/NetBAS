...
heatmap.2(z, col=my_palette, breaks=colors, dendrogram='none', Rowv=F, Colv=F,
...
#png(filename = "09.rnf43.tumor.bp.cor.matrix.png",width=6, height=5.5, res=1200, unit="in")

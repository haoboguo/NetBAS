...
```{r}
# PDAC cells
p.pos <- z.p[, which(z.p[20,] > 8)]
heatmap.2(p.pos, col=my_palette, breaks=colors, dendrogram='none',
          trace='none', Rowv=F, Colv=F, revC=T, labCol=NA,
          xlab="Biological Process Terms", ylab="Quantiles of Bayes Factors",
          margins = c(2,4), key.title = NA, key.xlab="Z-score", key.ylab=NA,
          scale="none", symbreaks=T, symm=F, symkey = F,
          main="Tumor cells, top 5% enriched")

p.neg <- z.p[, which(z.p[20,] < -8)]
heatmap.2(p.neg, col=my_palette, breaks=colors, dendrogram='none',
          trace='none', Rowv=F, Colv=F, revC=T, labCol=NA,
          xlab="Biological Process Terms", ylab="Quantiles of Bayes Factors",
          margins = c(2,4), key.title = NA, key.xlab="Z-score", key.ylab=NA,
          scale="none", symbreaks=T, symm=F, symkey = F,
...
# Normal Cells
np.pos <- z.np[, which(z.np[20,] > 8)]
heatmap.2(np.pos, col=my_palette, breaks=colors, dendrogram='none',
          trace='none', Rowv=F, Colv=F, revC=T, labCol=NA,
          xlab="Biological Process Terms", ylab="Quantiles of Bayes Factors",
          margins = c(2,4), key.title = NA, key.xlab="Z-score", key.ylab=NA,
          scale="none", symbreaks=T, symm=F, symkey = F,
...
np.neg <- z.np[, which(z.np[20,] < -8)]
heatmap.2(np.neg, col=my_palette, breaks=colors, dendrogram='none',
          trace='none', Rowv=F, Colv=F, revC=T, labCol=NA,
          xlab="Biological Process Terms", ylab="Quantiles of Bayes Factors",
          margins = c(2,4), key.title = NA, key.xlab="Z-score", key.ylab=NA,
          scale="none", symbreaks=T, symm=F, symkey = F,
...
heatmap.2(pvnp.pos, col=my_palette, breaks=colors, dendrogram='none',
          trace='none', Rowv=F, Colv=F, revC=T, labCol=NA,
          xlab="Biological Process Terms", ylab="PDAC vs Normal Cells, Quantiles",
          margins = c(2,4), key.title = NA, key.xlab="Z-score", key.ylab=NA,
          scale="none", symbreaks=T, symm=F, symkey = F,
...
heatmap.2(pvnp.neg, col=my_palette, breaks=colors, dendrogram='none',
          trace='none', Rowv=F, Colv=F, revC=T, labCol=NA,
          xlab="Biological Process Terms", ylab="PDAC vs Normal Cells, Quantiles",
          margins = c(2,4), key.title = NA, key.xlab="Z-score", key.ylab=NA,
          scale="none", symbreaks=T, symm=F, symkey = F,

...
write.table(bp.A, file="PvNP.bp.csv", sep=",", col.names=F, row.names=F, quote=F)
write.table(cc.A, file="PvNP.cc.csv", sep=",", col.names=F, row.names=F, quote=F)
write.table(mf.A, file="PvNP.mf.csv", sep=",", col.names=F, row.names=F, quote=F)
...
bp.output <- paste("ms02.human", "/", "PvNP", "/", "ms02.", p, ".bp.matrix.csv", sep="")
cc.output <- paste("ms02.human", "/", "PvNP", "/", "ms02.", p, ".cc.matrix.csv", sep="")
mf.output <- paste("ms02.human", "/", "PvNP", "/", "ms02.", p, ".mf.matrix.csv", sep="")
...
bp.hspin <- matrix(as.numeric(unlist(read.table("PvNP.bp.csv", header=F, sep=","))), nrow=bp.dim, ncol=2)
bp.obs <- c(bp.hspin)
cc.hspin <- matrix(as.numeric(unlist(read.table("PvNP.cc.csv", header=F, sep=","))), nrow=cc.dim, ncol=2)
cc.obs <- c(cc.hspin)
mf.hspin <- matrix(as.numeric(unlist(read.table("PvNP.mf.csv", header=F, sep=","))), nrow=mf.dim, ncol=2)
mf.obs <- c(mf.hspin)
...
mf.perm <- c()
for (i in 1:100) {
    bp.name <- paste("ms02.human", "/", "PvNP", "/", "ms02.", i, ".bp.matrix.csv", sep="")
    cc.name <- paste("ms02.human", "/", "PvNP", "/", "ms02.", i, ".cc.matrix.csv", sep="")
    mf.name <- paste("ms02.human", "/", "PvNP", "/", "ms02.", i, ".mf.matrix.csv", sep="")
...
bp.enriched.terms
write.table(bp.enriched.terms, file="PvNP.bp.enriched.txt", sep="\t", row.names = F, col.names = F, quote=F)
...
bp.suppressed.terms
write.table(bp.suppressed.terms, file="PvNP.bp.suppressed.txt", sep="\t", row.names = F, col.names = F, quote=F)
...
cc.enriched.terms
write.table(cc.enriched.terms, file="PvNP.cc.enriched.txt", sep="\t", row.names = F, col.names = F, quote=F)
...
cc.suppressed.terms
write.table(cc.suppressed.terms, file="PvNP.cc.suppressed.txt", sep="\t", row.names = F, col.names = F, quote=F)
...
mf.enriched.terms
write.table(mf.enriched.terms, file="PvNP.mf.enriched.txt", sep="\t", row.names = F, col.names = F, quote=F)
...
mf.suppressed.terms
write.table(mf.suppressed.terms, file="PvNP.mf.suppressed.txt", sep="\t", row.names = F, col.names = F, quote=F)
...
png(filename = "PvNP.bp.top10.png",width=3.5, height=6, res=1200, unit="in")
...
png(filename = "PvNP.mf.top10.png",width=3.5, height=6, res=1200, unit="in")
...
png(filename = "PvNP.cc.top10.png",width=3.5, height=6, res=1200, unit="in")
...
png(filename = "PvNP.cc.enriched.png",width=9, height=3.5, res=1200, unit="in")
heatmap.2(cc.z.enrich, col=my_palette, dendrogram='none', breaks=colors,
          sepcolor="lightgrey", sepwidth = c(0.05,0.01), 
          colsep = 1:ncol(cc.z.enrich), rowsep = 1:nrow(cc.z.enrich),
          trace='none', Rowv=F, Colv=F, #revC=T, #labCol=NA,
          xlab="Cellular Component Terms", ylab="",
...
png(filename = "PvNP.mf.enriched.png",width=9, height=3.5, res=1200, unit="in")
heatmap.2(mf.z.enrich, col=my_palette, dendrogram='none', breaks=colors,
          sepcolor="lightgrey", sepwidth = c(0.05,0.01), 
